...
# strong programming background from before. He should be able to solve problems which may involve 3 or 3
# Python classes or functions. The answers cannot be directly be found in the textbooks.
# Level 3	Advanced. He should use Python to solve more complex problem using more rich libraries functions
#  and data structures and algorithms. He is supposed to solve the problem using several Python standard packages
...
#
#Question:
#Define a class which has at least tw  o methods:
...
#Level 2
#Question:
#  rite a program which accepts a sequence of comma separated 4 digit binary numbers as its 
